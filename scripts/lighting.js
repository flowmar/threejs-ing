var demo = (function() {
  ...
  function setupGui() {
    ...
    var lightType = gui.add(itemsToControl, "lightType", [
      "directional",
      "point",
      "spot"
    ]);
    ...
    var showShadowCast = gui.add(itemsToControl, "showShadowCast", [
      "Yes",
      "No"
    ]);
    ...
    //cube
    var cubeMaterial = gui.add(itemsToControl, "cubeMaterial", [
      "phong",
      "lambert"
    ]);
  ...
  function changeLight(lightType) {
    ...
    if (lightType == "ambient") {
      light = new THREE.AmbientLight(
        new THREE.Color(itemsToControl.lightColor)
      );
      ...
      light.position.set(
        itemsToControl.lightXPos,
        itemsToControl.lightYPos,
        itemsToControl.lightZPos
      );
      light.castShadow = true;
    } else if (lightType == "point") {
      light = new THREE.PointLight(
        new THREE.Color(itemsToControl.lightColor),
        itemsToControl.lightIntensity,
